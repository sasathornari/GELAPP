...
class PortalRoutes {
    ...
    config(): void {
        ...
        this.router.get('/web/listuser', portalController.getListUserWeb);
        this.router.get('/web/user/:id,:pass', portalController.findUserLogin);
        this.router.get('/web/username/:id', portalController.findByUsername);
